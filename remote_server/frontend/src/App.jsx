...
function App() {
  ...
  // Update this line to use relative URLs instead of hardcoded ones
  const API_BASE_URL = '' // Empty string means use the same server that serves the frontend
  
  // Also uncomment the EventSource code and comment out the Socket.IO code in the useEffect
